...
public class Main {
	...
	public static String preguntarUsuario(String pregunta) {
		...
		System.out.println("\nPor favor, introduce " + pregunta + " de tu vehículo.");
		String respuesta;
	...
	public static void main(String[] args) {
		...
		do {
			...
			try {
				...
				type = preguntarUsuario("el TIPO (coche o moto)");
				if ((type.toLowerCase().contains("coche") || type.toLowerCase().contains("moto")) == true) {
						type = type;
				}else{
					throw new Exception("El TIPO solo puede ser COCHE o MOTO.");				
				};
				...
				//Crear objeto coche o moto, añadir las ruedas.
				
				if (type.contains("coche") == true) {
